...
<body>
	...
	{
		include 'koneksi.php';
		// $koneksi=mysqli_connect("localhost","root","","db_siak");
		$ambil=mysqli_query($koneksi,"INSERT INTO tb_peternakan 
		(nama_peternakan,jekel,umur,pendidikan,tanggungan_keluarga,status_ternak,
		pengalaman_beternak,status_lahan,alamat,modal_tetap,tenaga_kerja,bibit_sapi,
		penghasilan,mutasi_ternak, permasalahan,gambar,longitude,latitude,tanggal) VALUES
		('$_POST[nama_peternakan]',
		'$_POST[jekel]',
		'$_POST[umur]',
		'$_POST[pendidikan]',
		'$_POST[tanggungan_keluarga]',
		'$_POST[status_ternak]',
		'$_POST[pengalaman_beternak]',
		'$_POST[status_lahan]',
		'$_POST[alamat]',
		'$_POST[modal_tetap]',
		'$_POST[tenaga_kerja]',
